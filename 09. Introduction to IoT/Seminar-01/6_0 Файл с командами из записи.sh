...
sudo wget https://dl.grafana.com/oss/release/grafana_10.4.3_amd64.deb && \
sudo dpkg -i grafana_10.4.3_amd64.deb && \
sudo rm /root/grafana_10.4.3_amd64.deb && \
...
[[inputs.mqtt_consumer]]
  servers = ["tcp://192.168.0.xxx:1883"]
  topics = ["#"]
  username = "IoT"
  password = "student"
  data_format = "value"
